...
public class ThermostatOverview extends AppCompatActivity {
    ...
    int stemp, targetTemp;                  // value for temperature
    ...
    double currentTemp, targetTempS;         // value for temp
    TextView currentTempText;   // Text for current temperature
    TextView degree;            // Text for degree C

    //control window
    TimerTask taskTime;
    String getcurrentTemperature, gettargetTemperature;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void run() {
                try {
                    ...
                    if (getParamProgram.equals("off")) {                            // if program state is "off"
                        bweekprogram.post(new Runnable() {
        ...
        // temp display
        // set display to current temp of heating system
                        ...
                        try {
                            ...
                            if (on == true) {
                                ...
                                temp.post(new Runnable() {
                                    ...
                                    public void run() {
                                        temp.setText(target);
                                        tempbar.setProgress(targetTemp);
                                    }
                                });
                            }
                        } catch (Exception e) {
