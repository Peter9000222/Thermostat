...
public class HeatingSystem {
    ...
    public static WeekProgram getWeekProgram() throws ConnectException,
        ...
        try {
            ...
            ArrayList<SwitchHS> switches = new ArrayList<SwitchHS>();
            String current_day = "";
     ...
     * @throws IOException
     */
    private static ArrayList<SwitchHS> parseSwitches(XmlPullParser parser)
        ...
        while (parser.next() != XmlPullParser.END_DOCUMENT) {
            ...
            if (parser.getName().equals("switch")) {
                ...
                switches.add(new SwitchHS(type, status, time));
            }
        }
        return switches;
    }
    ...
    public static void put(String attribute_name, String value)
        ...
        if (attribute_name.equals("day")) {
            ...
            if (!SwitchHS.isValidTimeSyntax(value)) {
